            ...
            <div class='menusuperior'>
                <nav id="navbar-menusuperior" class="navbar navbar-light bg-light">
                    <ul class="nav nav-pills nav-fill">
                        ...
                        if (isset($userData)):
                            echo $this->Html->link('Administrador', '/Users/logout', array('class' => 'nav-link'));
                        else:
                            echo $this->Html->link('Login', '/Users/login', array('class' => 'nav-link'));
                        endif;
                        echo "</li>";
                        ?>
                        <?php echo "<li class='nav-item'>"; ?>
                        <?php echo $this->Html->link("Pautas", "/Pautas/", array('class' => 'nav-link')); ?>
                        <?php echo "</li>"; ?>
                        <?php echo "<li class='nav-item'>"; ?>
                        <?php echo $this->Html->link("Matérias", "/Materias/index/informandes:0", array('class' => 'nav-link')); ?>
                        <?php echo "</li>"; ?>
                        <?php echo "<li class='nav-item'>"; ?>
                        <?php echo $this->Html->link("Blog", "/Materias/blog/", array('class' => 'nav-link')); ?>
                        <?php echo "</li>"; ?>
                        <?php echo "<li class='nav-item'>"; ?>
                        <?php echo $this->Html->link("GTs e Setores", "/tags/", array('class' => 'nav-link')); ?>
                        <?php echo "</li>"; ?>
                        <?php echo "<li class='nav-item'>"; ?>
                        <?php echo $this->Html->link("Seções Sindiciais", "/Ssindicais/", array('class' => 'nav-link')); ?>
                        <?php echo "</li>"; ?>
                        <?php echo "<li class='nav-item'>"; ?>
                        <?php echo $this->Html->link("Histórico", "/historicos/", array('class' => 'nav-link')); ?>
                        <?php echo "</li>"; ?>
                        <?php echo "<li class='nav-item'>"; ?>
                        <?php echo $this->Html->link("TV Andes-SN", "http://www.youtube.com/user/sindicatoandes", array('class' => 'nav-link')); ?>
                        <?php echo "</li>"; ?>
                        <?php echo "<li class='nav-item'>"; ?>
                        <?php echo $this->Html->link("Plano de comunicação", "http://portal.andes.org.br/secretaria/gts/-%20Plano%20de%20Comunica%C3%A7%C3%A3o.pdf", array('class' => 'nav-link')); ?>
                        <?php echo "</li>"; ?>
